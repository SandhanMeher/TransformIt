...
export default function ScrollTriggered() {
  return (
    <div style={container}>
      {food.map(([emoji, image, hueA, hueB, url], i) => (
        <Card
          key={emoji}
          i={i}
          emoji={emoji}
...
function Card({ emoji, image, hueA, hueB, i, url }) {
 ...
 */
const food = [
  ["Img to Pdf", PdfFromImage, 250, 100, "/imageToPdf"],
  ["Pdf Compressor", PdfCompression, 200, 0, "/pdfCompression"],
  ["Pdf Merger", MergePdf, 60, 200, "/mergePdf"],
  ["Image Compressor", ImageCompressionn, 50, 290, "/imageCompression"],
  ["Excel to Pdf", PdfFromExcel, 10, 100, "/newFeatures"],
  ["Word to Pdf", WordFromPdf, 290, 50, "/newFeatures"],
];
